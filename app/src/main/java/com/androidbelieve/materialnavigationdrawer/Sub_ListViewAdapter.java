...
public class Sub_ListViewAdapter extends BaseAdapter {
    ...
    public Sub_ListViewAdapter(Context context, List<Stop> display_list) {
        mContext = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {  //we have in One screen  2 listviews
                ...
                if (display_list.get(position).getDirection().equals("1")) {  // To split the user input from different adapters.


                    Find_Activity.editsearch.setText(display_list.get(position).getStop_name());


                } else {
                    Find_Activity.editsearch2.setText(display_list.get(position).getStop_name());
